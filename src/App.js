  ...
  return (
    <div style={{ minHeight: "100vh", background: "#fafafa", color: "#2d2d2d", fontFamily: "-apple-system, sans-serif", paddingBottom: "60px" }}>
      ...
      <div style={{ background: "#fff", padding: "60px 25px 25px", borderBottom: "1px solid #f0f0f0" }}>
        ...
        <h1 style={{ margin: 0, fontSize: "24px", fontWeight: "700" }}>{tab.toUpperCase()}</h1>
              ...
              return (
                <div key={h.id} onClick={() => {
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                    ...
                    <span style={{ fontSize: "15px" }}>{h.label}</span>
                  </div>
                  {streak > 0 && <span style={{ fontSize: "11px", color: "#bbb" }}>🔥 {streak}</span>}
                </div>
              );
            })}
          </>
            ...
            {MONTHLY_ITEMS.map(m => {
              ...
              return (
                <div key={m.id} style={cardStyle}>
                  ...
                  <input placeholder="Add a note..." value={note} onChange={(e) => saveN({ ...notes, [`m${mSelect}_${m.id}`]: e.target.value })}
            ...
            {YEARLY_ITEMS.map(g => {
              ...
              return (
                <div key={g.id} style={cardStyle}>
                  ...
                  <input placeholder="Memo..." value={note} onChange={(e) => saveN({ ...notes, [g.id]: e.target.value })}
